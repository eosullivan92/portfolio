    ...
    <>
      <section className="hero-container" id="about">
        <div className="hero-content">
          ...
          <div className="about">
            <p>
              Welcome to my website. This is a space for me to shamelessly show
              off my skills and the projects that have been keeping me busy.{' '}
            </p>
            ...
            <p>
              Currently open to new opportunities so feel free to download my CV
